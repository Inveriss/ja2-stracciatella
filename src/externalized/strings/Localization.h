...
constexpr std::size_t gWeaponStatsDesc_SIZE = 20;
...
constexpr std::size_t pImpButtonText_SIZE = 59;
...
constexpr std::size_t MercInfo_SIZE = 16;
...
constexpr std::size_t BobbyRText_SIZE = 27;
...
// Section headers + labels for the tactical-screen "Infobox_stats.sti"
