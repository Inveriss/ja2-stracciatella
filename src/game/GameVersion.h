...
// 107: 256 profiles (IDs 0-255, NO_PROFILE stays 200), each with a bMercOpinion table of 256 entries,
// the IDs of the friends and enemies of a profile are two bytes.
