...
enum
{
	...
	MERC_FILES_LEAVE_MESSAGE,
	MERC_FILES_HANG_UP,
	MERC_FILES_MESSAGE_RECORDED,
	MERC_FILES_CLICK_HIRE_LINE1,
	MERC_FILES_CLICK_HIRE_LINE2,
};
...
enum
{
	...
	BOOKMARK_TEXT_MOVE_UP_ONE_POSITION,
};
